...
class Pdfs extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data['estudiante'] = $this->pdfs_model->getMatriculano();
...
// Establecemos el contenido para imprimir
        ...
        //IDHOJAMATRICULA
        $prov = "";
        $query = $this->db->query('SELECT * from hojamatricula where IDHOJAMATRICULA = '.$provincia);
        ...
        $html .= "</style>";
        $html .= "<h2>Estudiante de ".$prov."</h2><h4>Actualmente: ".count($provincias)." localidades</h4>";
        ...
        {
            $id = $row->IDHOJAMATRICULA;
            $localidad = $row->IDHOJAMATRICULA;
